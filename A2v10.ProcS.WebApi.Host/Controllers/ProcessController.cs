...
namespace A2v10.ProcS.WebApi.Host.Controllers
{
	...
	public class ProcessController : ControllerBase
	{
		...
		{
			var result = await _engine.StartWorkflow(prm.ProcessId, DynamicObjectConverters.From(prm.Parameters));
		}
		...
		{
			var instance = await _engine.ResumeWorkflow(prm.InstanceId, prm.Bookmark, DynamicObjectConverters.From(prm.Result));
		}
	}
}