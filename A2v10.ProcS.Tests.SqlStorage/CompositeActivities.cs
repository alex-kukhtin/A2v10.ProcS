...
namespace A2v10.ProcS.Tests.SqlStorage
{
	...
	public class CompositeActivities
	{
		...
		{
			(IWorkflowEngine engine, _, ServiceBus bus) = ProcessEngine.CreateSqlEngine();
		...
		{
			(IWorkflowEngine engine, IRepository repository, ServiceBus bus) = ProcessEngine.CreateSqlEngine();
